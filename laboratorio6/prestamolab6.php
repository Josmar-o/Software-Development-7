<?php
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            try {
                ...
                // HACE LA COOKIE (debe ir antes de cualquier salida)
                setcookie("usuario_nombre", $_POST["nombre"], time() + 3600); // 1 hora

                echo "<div style='margin-top: 20px; padding: 20px; background-color:rgb(220, 235, 254); border-radius: 8px; border: 1px solid rgb(21, 36, 97);'>";
                echo "<h3 style='color:rgb(46, 66, 125); margin-bottom: 15px;'>Datos Validados Correctamente:</h3>";
                echo "<div style='display: grid; grid-template-columns: 1fr 1fr; gap: 10px;'>";

                
                echo "<p style='color: green;'>Cookie 'usuario_nombre' creada.</p>";
...
<body>
    <div class="form-container">
        ...
        <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
            ...
            <a href="bienvenida.php" class="boton" >   Ir a la página de Bienvenida</a>
            <a href="cerrar_sesion.php" class="boton" >Cerrar Sesion o Borrar Cookie</a>
